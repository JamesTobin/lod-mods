...
local ball_spawner_update_form = function (pos)
		...
		if meta:get_int("admin")==1 then 
			...
			form = form .. "field[2.25,2.5;1,1;lifetime;lifetime;"..lifetime.."] field[1.25,2.5;1,1;hurt;hurt;"..hurt.."]"
		end
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		if fields.OK then
			...
			if fields.scale then
				...
				if scale>200 and not privs.privs then scale = 200 end
